  ...
  return (
    <div>
      ...
      <button
        ...
        className={`w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-900 rounded-xl px-6 py-3 font-medium flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed ${className}`}
      >
        {loading ? (
